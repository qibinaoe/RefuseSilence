...
Page({
  ...
  data: {
    ...
    navList:[
      {icon:'/images/nav-icon/diantai.png',events:'goToBangDan',text:'榜单'},
      {icon:'/images/nav-icon/diantai.png',events:'goToBangDan',text:'听小说'},
      {icon:'/images/nav-icon/diantai.png',events:'goToBangDan',text:'情感电台'},
      {icon:'/images/nav-icon/diantai.png',events:'goToBangDan',text:'听知识'},
